...
def draw_bounding_box_on_image(image,
  ...
  try:
    font = ImageFont.truetype('/home/dustin/.fonts/Asparagus_Sprouts.ttf', 20)
...
def draw_mask_on_image(pil_image, mask, color='red', alpha=0.4):
  ...
  pil_solid_color = Image.fromarray(np.uint8(solid_color)).convert('RGBA')
  pil_mask = Image.fromarray(np.uint8(255.0*alpha*mask)).convert('L')
  pil_mask.save('/tmp/pil_mask.jpg',format='JPEG')
  pil_mask.resize(pil_image.size)
  pil_mask.save('/tmp/pil_mask_resize.jpg', format='JPEG')
  pil_image = Image.composite(pil_solid_color, pil_image, pil_mask)
